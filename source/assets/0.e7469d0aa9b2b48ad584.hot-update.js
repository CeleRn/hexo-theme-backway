...
$(".form-input__input").on('focus', function () {
    $(this).parents('.form__input-block').children(".form__icon").addClass('form__icon_hovered');
}).on('focusout', function () {
    $(this).parents('.form__input-block').children(".form__icon").addClass('form__icon_error');
});
