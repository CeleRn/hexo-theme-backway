...
$(".form-input__input").on('focus', function () {
    $(this).parents('.form__input-block').children(".form__icon").css("fill", "blue");
});

$(".form-input__input").on('focusout', function () {
    $(this).parents('.form__input-block').children(".form__icon").css("fill", "green");
});
